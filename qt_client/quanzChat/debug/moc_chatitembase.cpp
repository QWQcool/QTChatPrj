...
static constexpr auto qt_meta_stringdata_CLASSChatItemBaseENDCLASS = QtMocHelpers::stringData(
    "ChatItemBase"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSChatItemBaseENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSChatItemBaseENDCLASS_t qt_meta_stringdata_CLASSChatItemBaseENDCLASS = {
    {
        QT_MOC_LITERAL(0, 12)   // "ChatItemBase"
    },
    "ChatItemBase"
};
