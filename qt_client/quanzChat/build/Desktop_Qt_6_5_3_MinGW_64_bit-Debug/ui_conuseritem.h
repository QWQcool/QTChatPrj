...
public:
    ...
    void setupUi(QWidget *ConUserItem)
    {
        ...
        icon_lb->setGeometry(QRect(2, 10, 45, 45));
        ...
        user_name_lb->setMaximumSize(QSize(16770700, 16777215));
    ...
    void retranslateUi(QWidget *ConUserItem)
    {
        ...
        icon_lb->setText(QCoreApplication::translate("ConUserItem", "<html><head/><body><p><br/></p></body></html>", nullptr));
