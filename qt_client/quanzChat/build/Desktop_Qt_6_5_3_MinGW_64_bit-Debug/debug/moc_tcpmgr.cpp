...
Q_CONSTINIT static const qt_meta_stringdata_CLASSTcpMgrENDCLASS_t qt_meta_stringdata_CLASSTcpMgrENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(82, 16),  // "sig_login_failed"
        QT_MOC_LITERAL(99, 15),  // "sig_user_search"
        QT_MOC_LITERAL(115, 27),  // "std::shared_ptr<SearchInfo>"
        QT_MOC_LITERAL(143, 16),  // "sig_friend_apply"
        QT_MOC_LITERAL(160, 31),  // "std::shared_ptr<AddFriendApply>"
        QT_MOC_LITERAL(192, 19),  // "sig_add_auth_friend"
        QT_MOC_LITERAL(212, 25),  // "std::shared_ptr<AuthInfo>"
        QT_MOC_LITERAL(238, 12),  // "sig_auth_rsp"
        QT_MOC_LITERAL(251, 24),  // "std::shared_ptr<AuthRsp>"
        QT_MOC_LITERAL(276, 16),  // "slot_tcp_connect"
        QT_MOC_LITERAL(293, 10),  // "ServerInfo"
        QT_MOC_LITERAL(304, 14)   // "slot_send_data"
    },
    "TcpMgr",
    "sig_con_success",
    "",
