...
public:
    ...
    void setupUi(QWidget *ChatPage)
    {
        ...
        title_wid->setMinimumSize(QSize(0, 45));
        title_wid->setMaximumSize(QSize(16777215, 45));
        ...
        horizontalLayout_3->setContentsMargins(2, 3, 0, 1);
        ...
        sizePolicy.setHeightForWidth(emo_lb->sizePolicy().hasHeightForWidth());
        emo_lb->setSizePolicy(sizePolicy);
        ...
        chat_edit->setMaximumSize(QSize(16777215, 130));
        chat_edit->setToolTipDuration(0);

        verticalLayout_4->addWidget(chat_edit);

        send_wid = new QWidget(chat_data_wid);
        send_wid->setObjectName("send_wid");
        send_wid->setMinimumSize(QSize(0, 45));
        send_wid->setMaximumSize(QSize(16777215, 45));
        horizontalLayout_5 = new QHBoxLayout(send_wid);
        horizontalLayout_5->setSpacing(0);
        horizontalLayout_5->setObjectName("horizontalLayout_5");
        horizontalLayout_5->setContentsMargins(-1, 0, 6, 4);
    ...
    void retranslateUi(QWidget *ChatPage)
    {
        ...
        title_lb->setText(QCoreApplication::translate("ChatPage", "friend_name", nullptr));
