...
public:
    ...
    void setupUi(QDialog *ChatDialog)
    {
        ...
        sizePolicy1.setHeightForWidth(side_head_lb->sizePolicy().hasHeightForWidth());
        side_head_lb->setSizePolicy(sizePolicy1);
        ...
        chat_user_wid->setMaximumSize(QSize(200, 16777215));
        ...
        search_wid->setMinimumSize(QSize(0, 40));
        search_wid->setMaximumSize(QSize(16777215, 40));
        ...
        chat_user_list->setMinimumSize(QSize(0, 60));
