...
private:
	...
	void AuthFriendApply(shared_ptr<CSession>, const short& msg_id, const string& msg_data);
	void DealChatTextMsg(shared_ptr<CSession>, const short& msg_id, const string& msg_data);
